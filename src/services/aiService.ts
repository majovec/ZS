...
${activeGoals
  ...
  private generateRuleBasedResponse(userMessage: string): string {
    ...
    if (
      lowerMessage.includes('rozpočet') ||
      lowerMessage.includes('plán')
    ) {
    ...
    if (
      lowerMessage.includes('investic') ||
      lowerMessage.includes('vklad')
    ) {
